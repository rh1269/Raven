...
public class EvadeTargetGoal_Evaluator extends Goal_Evaluator {

	public EvadeTargetGoal_Evaluator(Double bias) {
		super(bias, GoalType.goal_evade);
	}
	...
	public void setGoal(RavenBot pEnt){
		pEnt.getBrain().addGoal_evade(pEnt); 
	}
